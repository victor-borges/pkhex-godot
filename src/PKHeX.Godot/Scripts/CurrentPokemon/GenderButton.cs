...
public partial class GenderButton : TextureButton
{
    ...
    private void CurrentPokemonChanged()
    {
        ...
        TextureNormal = GD.Load<Texture2D>($"res://Assets/Sprites/Gender/gender_{genderIndex}.svg");
    }

    private void OnFileLoaded(string _)
    {
        TextureNormal = GD.Load<Texture2D>($"res://Assets/Sprites/Gender/gender_2.svg");
    }
}
